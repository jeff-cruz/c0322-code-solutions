...
console.log('The author of the second book, "', bookshelf[1].title, '" is', bookshelf[1].author);
console.log('The ISBN of the first book,"', bookshelf[0].title, '" is', bookshelf[0].isbn);
