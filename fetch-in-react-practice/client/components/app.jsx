...
export default class App extends React.Component {
  ...
  componentDidMount() {
    ...
    fetch('/api/todos')
      ...
      .catch(err => console.error('Fetched GET failed!', err));
  }
  ...
  addTodo(newTodo) {
    ...
    */
    fetch('/api/todos', {
      ...
      .catch(err => console.error('Fetched POST failed!', err));
  }
  ...
  toggleCompleted(todoId) {
    ...
    const { isCompleted } = todos[index];
    const status = { isCompleted: !isCompleted };
    ...
    fetch(`/api/todos/${todoId}`, {
      ...
      .catch(err => console.error('Fetched PATCH failed!', err));
