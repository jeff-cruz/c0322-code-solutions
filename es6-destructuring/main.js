...
const { title: newTitle, author: newAuthor, libraryID: newID } = book2;
console.log('The title of the book is ' + newTitle + ', the author is ' + newAuthor + ', and the library id is ' + newID);
